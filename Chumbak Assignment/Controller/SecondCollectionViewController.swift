...
class SecondCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "secondCollectionCell", for: indexPath)
    ...
    override func viewWillLayoutSubviews() {
        ...
        layout.itemSize.width = min((collectionView?.bounds.size.width)! - 100, 84)
    }
